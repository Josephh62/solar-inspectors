...
function AppleLogo() {
  return (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-2.117 3.675-.546 9.103 1.519 12.09 1.013 1.459 2.208 3.096 3.792 3.039 1.52-.065 2.09-.987 3.925-.987 1.831 0 2.35.987 3.96.948 1.637-.026 2.676-1.48 3.676-2.948 1.156-1.688 1.636-3.325 1.662-3.415-.039-.013-3.182-1.221-3.221-4.857-.026-3.04 2.483-4.494 2.6-4.559-1.423-2.099-3.638-2.333-4.429-2.379l-.563-.006zM15.53 3.83c.843-1.012 1.4-2.427 1.245-3.83-1.207.052-2.662.805-3.532 1.818-.77.896-1.454 2.338-1.273 3.714 1.338.104 2.715-.688 3.559-1.701z" />
    </svg>
  );
}
  ...
  return (
    <div className="min-h-screen bg-[#060c18] flex flex-col items-center justify-center px-6">
      ...
      <div className="flex items-center gap-2.5 mb-12">
        <AvaxLogo className="w-10 h-10" />
        <span className="font-black text-2xl tracking-tight text-white">AVAX</span>
      </div>

      {/* Card */}
      <div className="w-full max-w-sm">
        <h1 className="text-2xl font-black tracking-tight text-white text-center mb-2">Sign in</h1>
